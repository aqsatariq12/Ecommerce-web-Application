                ...
                <div class="cat-blocks-container">
                    <div class="row">
                        <div class="col-6 col-sm-4 col-lg-2">
                            <a href="products.php" class="cat-block">
                                <figure>
                                    <span>
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">MacBook Pro 13" Display, i5</a></h3><!-- End .product-title -->
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Bose - SoundLink Bluetooth Speaker</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $79.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Apple - 11 Inch iPad Pro  with Wi-Fi 256GB </a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $899.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Google - Pixel 3 XL  128GB</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                            ...
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Samsung - 55" Class  LED 2160p Smart</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $899.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                ...
                <div class="row">
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('assets/images/demos/demo-4/deal/bg-1.jpg');">
                            ...
                            <div class="deal-content">
                                <h3 class="product-title"><a href="product-detail.php">Home Smart Speaker with  Google Assistant</a></h3><!-- End .product-title -->
                                ...
                                <a href="product-detail.php" class="btn btn-link"><span>Shop Now</span><i class="icon-long-arrow-right"></i></a>
                    ...
                    <div class="col-lg-6 deal-col">
                        <div class="deal" style="background-image: url('assets/images/demos/demo-4/deal/bg-2.jpg');">
                            ...
                            <div class="deal-content">
                                <h3 class="product-title"><a href="product-detail.php">Certified Wireless Charging  Pad for iPhone / Android</a></h3><!-- End .product-title -->
                                    ...
                                    <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product-detail.php">Bose - SoundSport  wireless headphones</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $199.99
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product-detail.php">Microsoft - Refurbish Xbox One S 500GB</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $279.99
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product-detail.php">Apple Watch Series 4 Gold Aluminum Case</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                                                    $499.99
                                                </div><!-- End .product-price -->
                                                <div class="ratings-container">
                                        ...
                                        <div class="product product-2">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product-detail.php">Sony - Class LED 2160p Smart 4K Ultra HD</a></h3><!-- End .product-title -->
                                                <div class="product-price">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Beats by Dr. Dre Wireless  Headphones</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">GoPro - HERO7 Black HD Waterproof Action</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $349.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Apple - Apple Watch Series 3 with White Sport Band</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $214.49
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Lenovo - 330-15IKBR 15.6"</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Sony - Alpha a5100 Mirrorless Camera</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $499.99
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Home Mini - Smart Speaker  with Google Assistant</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $49.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">WONDERBOOM Portable Bluetooth Speaker</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                        ...
                        <div class="col-6 col-md-4 col-lg-3">
                            <div class="product product-2">
                                ...
                                <div class="product-body">
                                    ...
                                    <h3 class="product-title"><a href="product-detail.php">Google - Home Hub with  Google Assistant</a></h3><!-- End .product-title -->
                                    <div class="product-price">
                                        $149.00
                                    </div><!-- End .product-price -->
                                    <div class="ratings-container">
