...
<!-- molla/product-detail.php  22 Nov 2019 09:54:50 GMT -->
<head>
    <meta charset="UTF-8">
                    ...
                    <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl" 
                        ...
                        <div class="product product-7 text-center">
                            ...
                            <div class="product-body">
                                ...
                                <h3 class="product-title"><a href="product-detail.php">Brown paperbag waist <br>pencil skirt</a></h3><!-- End .product-title -->
                                <div class="product-price">
                                    $60.00
                                </div><!-- End .product-price -->
                                <div class="ratings-container">
        ...
        <div class="container">
            <div class="row">
                <div class="col-6">
                    ...
                    <h4 class="product-title"><a href="product-detail.php">Dark yellow lace cut out swing dress</a></h4><!-- End .product-title -->
                </div><!-- End .col-6 -->
...
<!-- molla/product-detail.php  22 Nov 2019 09:55:05 GMT -->
</html>